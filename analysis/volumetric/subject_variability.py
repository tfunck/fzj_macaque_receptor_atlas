...
def create_averaged_volumes(data_dict, ligand_list, output_dir):
    ...
    for ligand in ligand_list :
        ...
        nib.Nifti1Image(avg_vol, img.affine).to_filename(f'{output_dir}/macaque_{ligand}.nii.gz')
...
if __name__ == '__main__':
    ...
    data_dict, ligands = get_subject_data(subjects, hemispheres, data_dir)

    #hemispheric_symmetry(data_dict , output_dir)

    create_averaged_volumes(data_dict, ligands, output_dir+'/averages/')
    exit(0)
