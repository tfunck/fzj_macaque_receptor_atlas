...
if __name__ == '__main__' :
    ...
    parser.add_argument('-o', dest='output_dir', type=str, default=f'{wrk_dir}/outputs/', help='Path to output directory')
    ...
    receptor_dir = f"{args.input_dir}/receptor_n-3/"
    ...
    run_developmental_analysis = True

    viz_receptors = False


    volume_feature_dict = {'receptor':receptor_volumes, 'medial_wall_mask': [args.medial_wall_volume_filename]}
